          ...
          return (
            <button key={h.id} type="button" onClick={() => onChange(h.id)}
              ...
              <div className="bf-hosp-initials"
                style={{ background: net?.color_bg || "#0B2540", color: net?.color_text || "#FAF6EC" }}>
  ...
  if (loading) return (
    <div className="bf-loading">
      <div className="bf-loading-inner">
        <div className="bf-loading-brand">SAVIOR</div>
    ...
    <div className="bf-shell">
      ...
      <div className="bf-topbar">
        <div className="bf-topbar-brand">
          <span className="bf-topbar-wordmark">SAVIOR</span>
          <span className="bf-topbar-service">Medical Service</span>
        </div>
